...
* component 
  ...
  pause container is the container holds all the containers of a pod together, pod shared same network and other namespace is provided by this pause container
** Master node: 
*** Base components: 
