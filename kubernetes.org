...
* Network security
  ...
  spec.containers.securityContext.runAsUser, change container run user

  spec.containers.securityContext.runAsNonRoot, set to true prevent container run as root
